...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/03/15 03:18:01 by ainouni           #+#    #+#             */
/*   Updated: 2025/03/15 03:18:02 by ainouni          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		double wall_strip_height)
{
	...
	draw_textured_strip(i, wall_top, wall_bottom, (t_draw_params){tex_x,
		current_texture, wall_strip_height, ray->is_door, 0, ray->hit_vertical,
		ray->ray_angle, ray->ray_distance, mlx});
}
...
void	draw_3d_scene(t_mlxing *mlx)
{
	...
	render_3d_view(mlx);
	draw_minimap(mlx);
	render_animation(mlx, mlx->shoot_animation, 200, WINDOW_HEIGHT - 200);
}
