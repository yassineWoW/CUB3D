...
typedef struct s_animation {
    ...
    int     is_playing;    // Whether the animation is playing
    int     loop;          // Whether the animation should loop
    double  frame_time;    // Time per frame (in seconds)
    double  elapsed_time;  // Time since last frame change
} t_animation;
...
void	load_animation(t_mlxing *mlx, t_animation *anim, const char *folder, int frame_count);
