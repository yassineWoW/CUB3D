...
int is_collision(double new_x, double new_y, t_mlxing *mlx)
{
    ...
    int num_samples = 8; // Number of points around the circle to check
...
int move_player(int key, t_mlxing *mlx)
{
    ...
    // Ensure mlx and player data are valid
    ...
    {
        return 0; // No valid movement key
    }
    ...
    return 0; // Movement blocked by collision
}
